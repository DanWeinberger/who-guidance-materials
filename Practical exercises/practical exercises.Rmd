...
```{r}
#install.packages(c('lubridate', 'RCurl','devtools','xtable','knitr','htmlTable','coda'))
#library(devtools) 
...
##Getting started
Before starting, you should install R and Rstudio on your computer. 
...
SWITCHEROOO---start using data from package instead
...
### Run ITS analysis
```{r}
impact_results_time = evaluatr.impact(analysis, variants='time')
