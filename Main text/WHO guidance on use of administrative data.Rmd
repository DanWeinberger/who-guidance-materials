...
Let's just compare the Rate ratio estimates from the different ITS models we have tested so far. TODO::CHECK DATES USED HERE--KNOTS SEEMS TO BE DIFFERENT
```{r}
