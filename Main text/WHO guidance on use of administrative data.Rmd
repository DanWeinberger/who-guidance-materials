---
title: Measuring the impact of new vaccines using mortality and administrative hospitalization
  data
...
<style>
.list-group-item.active, .list-group-item.active:focus, .list-group-item active:cursor:pointer, cursor: pointer {
    color: #507894;
}
</style>
...
text(as.Date('2014-01-01'), 15000, 'Counterfactual', col='#d95f02', cex=0.5,pos=2, offset=0)
text(as.Date('2014-01-01'), 8000, 'Fitted', col='#7570b3', cex=0.5,pos=2, offset=0)
