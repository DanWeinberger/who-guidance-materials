...
plot(kids$date, kids$J12_J18_prim, type='l', bty='l', ylab="N hospitalizations", xlab='date', ylim=c(0, max(kids$J12_J18_prim)), main='Time series of pneumonia cases')
...
plot(kids$date, kids$J12_J18_prim, type='l', bty='l', ylab="N hospitalizations", xlab='date', ylim=c(0, max(kids$J12_J18_prim)), main='Pre-post comparison')
abline(v=as.Date('2010-08-01'), lty=2, col='gray')
arrows(x0=as.Date('2005-01-01'), x1=as.Date('2010-07-01') , y0=mean.pre, length=0, col='#1b9e77')
arrows(x0=as.Date('2011-08-01'), x1=as.Date('2016-12-01') , y0=mean.post, length=0, col='#7570b3')
...
plot(kids$date, kids$J12_J18_prim, type='p',pch=16,cex=0.75, bty='l',col='lightgray', ylab="N hospitalizations", xlab='date', ylim=c(0, max(kids$J12_J18_prim)), main='Counterfactual for pre/post comparisons')
arrows(x0=as.Date('2005-01-01'), x1=as.Date('2010-07-01') , y0=mean.pre, length=0, col='#1b9e77')
...
par(mfrow=c(2,1))
plot(kids$date, kids$J12_J18_prim, type='p', pch=16, bty='l', ylab="N hospitalizations", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids$J12_J18_prim)),main='Pre/post comparison with adjustment for season' )
...
par(mfrow=c(2,1))
plot(kids$date, kids$J12_J18_prim, type='p', pch=16, bty='l', ylab="N hospitalizations", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids$J12_J18_prim)), main='ITS, with disjointed segments')
points(kids$date,pred1.pre, type='l' ,col='#1b9e77' )
points(kids$date,pred1.post, type='l' , col='#7570b3' )
points(kids$date,pred1.counter, type='l', col='#d95f02', lty=3  )
abline(v=as.Date('2010-08-01'), lty=3, col='gray')
...
par(mfrow=c(2,1))
plot(kids$date, kids$J12_J18_prim, type='p', pch=16, bty='l', ylab="N hospitalizations", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids$J12_J18_prim)), main='ITS, with connected segments')
points(kids$date,pred1.pre, type='l' ,col='#1b9e77' )
points(kids$date,pred1.post, type='l' , col='#7570b3' )
points(kids$date,pred1.counter, type='l', col='#d95f02', lty=3  )
abline(v=as.Date('2010-08-01'), lty=3, col='gray')
...
kids$spl1[kids$spl1<0]<-0
kids$spl2[kids$spl2<0]<-0
kids$log.offset <- 0 #let's ignore offset for now and just set to 0
...
par(mfrow=c(2,1))
plot(kids$date, kids$J12_J18_prim, type='p', pch=16, bty='l', ylab="N hospitalizations", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids$J12_J18_prim)), main='ITS, with leveling of the trend')
points(kids$date,pred1.pre, type='l' ,col='#1b9e77' )
points(kids$date,pred1.post, type='l' , col='#7570b3' )
points(kids$date,pred1.counter, type='l', col='#d95f02', lty=3  )
abline(v=as.Date('2010-08-01'), lty=3, col='gray')
...
Using the same dataset from Brazil that was used in the ITS example, we will evaluate changes in J12-J18 following introduction of the vaccine. We will fit the model just to data form the pre-vaccine period, adjusting for seaosnality and the control variable. As an example, we will use log(all-cause)
```{r}
...
plot(kids$date, kids$J12_J18_prim, type='p', pch=16, bty='l', ylab="N hospitalizations", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids$J12_J18_prim)), main='Fit of synthetic control model')
...
plot(kids$date, kids$J12_J18_prim, type='p', pch=16, bty='l', ylab="N hospitalizations", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids$J12_J18_prim)), main='Extrapolation to post-vaccine period')
