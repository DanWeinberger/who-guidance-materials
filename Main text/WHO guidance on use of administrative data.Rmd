...
plot(kids$date, kids[,outcome.name], type='l', bty='l', ylab="N Deaths", xlab='date', ylim=c(0, max(kids[,outcome.name])), main='Time series of pneumonia deaths')
...
plot(kids$date, kids[,outcome.name], type='l', bty='l', ylab="N Deaths", xlab='date', ylim=c(0, max(kids[,outcome.name])), main='Pre-post comparison')
abline(v=intro.date, lty=2, col='gray')
...
plot(kids$date, kids[,outcome.name], type='p',pch=16,cex=0.75, bty='l',col='lightgray', ylab="N Deaths", xlab='date', ylim=c(0, max(kids[,outcome.name])), main='Counterfactual for pre/post comparisons')
arrows(x0=first.date, x1=intro.date.minus.one , y0=mean.pre, length=0, col='#1b9e77')
arrows(x0=eval.date, x1=last.date , y0=mean.post, length=0, col='#7570b3')
...
par(mfrow=c(2,1))
plot(kids$date, kids[,outcome.name], type='p', pch=16, bty='l', ylab="N Deaths", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids[,outcome.name])),main='Pre/post comparison with adjustment for season' )
...
par(mfrow=c(2,1))
plot(kids$date, kids[,outcome.name], type='p', pch=16, bty='l', ylab="N Deaths", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids[,outcome.name])), main='ITS, with disjointed segments')
points(kids$date,pred1.pre, type='l' ,col='#1b9e77' )
points(kids$date,pred1.post, type='l' , col='#7570b3' )
points(kids$date,pred1.counter, type='l', col='#d95f02', lty=3  )
abline(v=intro.date, lty=3, col='gray')
...
par(mfrow=c(2,1))
plot(kids$date, kids[,outcome.name], type='p', pch=16, bty='l', ylab="N Deaths", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids[,outcome.name])), main='ITS, with connected segments')
points(kids$date,pred1.pre, type='l' ,col='#1b9e77' )
points(kids$date,pred1.post, type='l' , col='#7570b3' )
points(kids$date,pred1.counter, type='l', col='#d95f02', lty=3  )
abline(v=intro.date, lty=3, col='gray')
...
par(mfrow=c(2,1))
plot(kids$date, kids[,outcome.name], type='p', pch=16, bty='l', ylab="N Deaths", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids[,outcome.name])), main='ITS, with leveling of the trend')
points(kids$date,pred1.pre, type='l' ,col='#1b9e77' )
points(kids$date,pred1.post, type='l' , col='#7570b3' )
points(kids$date,pred1.counter, type='l', col='#d95f02', lty=3  )
abline(v=intro.date, lty=3, col='gray')
...
# plot(kids$date, kids[,outcome.name]/kids$acm_noj_prim, type='p', pch=16, bty='l', ylab="Adj N hospitalizations", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids[,outcome.name]/kids$acm_noj_prim)), main='ITS, adjusted')
...
form1<-as.formula(paste0('outcome_pre','~month+ index +spl1 + spl2 +log.offset'))
mod1<-glm(form1,family='quasipoisson', data=kids)
fit.outcome.pre<-predict(mod1, type='response')

plot(kids$date, kids[,outcome.name], type='p', pch=16, bty='l', ylab="N Deaths", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids[,outcome.name])), main='Fit of synthetic control model')
...
plot(kids$date, kids[,outcome.name], type='p', pch=16, bty='l', ylab="N Deaths", col='gray', cex=0.7,  xlab='date', ylim=c(0, max(kids[,outcome.name])), main='Extrapolation to post-vaccine period')
...
plot(ds.sub$monthdate,ds.sub[,outcome.name], type='l', bty='l', col='blue', xlab='Date', ylab='J12-18', ylim=c(0, max(ds.sub[,outcome.name])))
